export function init() {
  loadIframe({
    id: "Slide3-9WebActivity",
    src: "../../actividades/drag_and_drop_audio/index.html",
    srcMobile: "../../actividades/drag_and_drop_audio_movil/index.html",
    className: "iframe-actividad-lumi",
    style: "min-width:1000px;height: 420px",
    styleMobile: "min-width:320px;height: 100vh"
  });

  // Actividad de señales de tránsito
  const signalsData = [
    { id: "reglamentarios", text: "Trabajos en andamios​", image: "momento1_7/img/colapsio_andamio.webp" },
    { id: "preventivas", text: "Trabajos en paredes", image: "momento1_7/img/golpe_estructura.webp" },
    { id: "transitorias", text: "Trabajos en estructuras​", image: "momento1_7/img/caida_perdida_estabilidad.webp" },
    { id: "informativas", text: "Trabajos en techos y cubiertas​", image: "momento1_7/img/desplazamiento_herramientas.webp" }
  ];
  ...
  function updateUI() {
    ...
    if (isValidated && validationResult) {
      ...
      if (validationResult.correctCount === validationResult.totalCount) {
        validationText.innerHTML = '<strong>¡Muy bien! ¡Has identificado correctamente los diferentes tipos de riesgos!</strong>';
      } else {
